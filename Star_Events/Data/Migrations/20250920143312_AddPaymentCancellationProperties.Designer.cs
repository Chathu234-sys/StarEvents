...
namespace Star_Events.Data.Migrations
{
    ...
    [Migration("20250920143312_AddPaymentCancellationProperties")]
    partial class AddPaymentCancellationProperties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Star_Events.Data.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Star_Events.Data.Entities.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Star_Events.Data.Entities.Booking", b =>
                {
                    b.HasOne("Star_Events.Models.ApplicationUser", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("Star_Events.Data.Entities.Ticket", b =>
                {
                    ...
                    b.HasOne("Star_Events.Data.Entities.BookingItem", "BookingItem")
                        .WithMany()
